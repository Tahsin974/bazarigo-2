      ...
      {loading || isPending ? (
        ...
        <div className="space-y-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-4 gap-4">
            ...
            />
            <StatCard title="Return Requests" value={returnRequests.length} />
          </div>
          ...
          <div className="flex flex-col gap-6 h-min">
            ...
            {dashboard.categoryData.length ? (
              ...
              >
                ...
                >
                  <BarChart data={dashboard.categoryData} barCategoryGap="20%">
                    {/* Gradient Definition */}
                    <defs>
                      <linearGradient
                        id="barGradient"
                        ...
                        <tr key={r.id} className="border-t">
                          ...
                          <td>
                            <div className="flex items-center gap-2 justify-center">
                              <button
                                onClick={() => openImageGalleryModal(r.images)}
