...
export default function ToysBabyProductsSection() {
  const { data: products, isPending } = useToysCategoryProducts();
  return (
    <section className="md:py-10 py-6 bg-gray-50">
      {isPending ? (
        ...
        <div className="container mx-auto xl:px-6 lg:px-6  px-4">
          <SectionTitle title={"Toys & Baby Products"} showViewAll={false} />
