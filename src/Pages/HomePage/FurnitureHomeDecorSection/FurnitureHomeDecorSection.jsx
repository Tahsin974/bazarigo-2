...
export default function FurnitureHomeDecorSection() {
  const { data: products = [], isPending } = useFurnitureCategoryProducts();
  return (
    <section className="md:py-10 py-6 bg-gray-50">
      {isPending ? (
        ...
        <div className="container mx-auto xl:px-6 lg:px-6  px-4">
          <SectionTitle title={"Furniture & Home Decor"} showViewAll={false} />
